...
int main()
{
    ...
    //LA�O PARA CARREGAR OS VALORES NA MATRIZ
    for (i = 0; i < 5; i++)
    {
...
// LA�O PARA EXIBIR OS VALORES CALCULADOS/INFORMADOS, DE ACORDO COM AS CONDI��ES ABAIXO
    for (i = 0; i < 5; i++)
    {
...
// ANALISE DAS CONDI��ES DE PESO IDEAL, CONFORME VALOR REFERENCIA DE 25
        if (infos[i][imc] > 25)
        {
