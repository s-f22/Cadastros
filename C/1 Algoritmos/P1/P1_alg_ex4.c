...
04-Desenvolva um programa em C do problema a seguir (2,5): Utilizando comandos de seleção aninhados, 
...
//inicio dos processamentos	
	...
	if (sLiq > 0 && sLiq <= 1020.0)		//identifica condição de isenção do IR
	{
		//bloco de saida de dados, devolvendo as informações calculadas ao usuario
		printf("\nIsento de IR. \n");
